<template>
  <div class="eliminacionGauss">
    <h1>Eliminación Gausseana con Pivoteo Total</h1>
    ...
    <div>
      ...
      <h3>Paso {{ index }}</h3>
      <table v-if="paso['U']" style="width: 20%; margin: 20px auto; border-width: 1px;">
        <thead>
          <tr>
            <th>U</th>
          </tr>
      ...
      <p></p>
      <ul v-if="paso['x']" style="width: 20%; margin: 0px auto; list-style: none;">
