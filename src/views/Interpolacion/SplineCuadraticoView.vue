<template>
  <div class="splineCuadratico">
    <h1>Spline Cuadrático</h1>
    ...
    <div>
      ...
      <table style="width: 60%; margin: 20px auto; border-width: 1px;">
        <tbody>
          <tr v-for="fila in solution['A']" :key="fila">
      ...
      <ul style="width: 20%; margin: 0px auto; list-style: none;">
        <li v-for="(value, fila) in solution['b']" :key="fila">
          <strong>b({{ fila }}): </strong>{{ value }}
        </li>
      </ul>
      <p></p>
      <ul style="width: 20%; margin: 0px auto; list-style: none;">
        <li v-for="(value, fila) in solution['x']" :key="fila">
